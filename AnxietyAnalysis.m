...
fname = 'eeg_walking_anxiety'; %File name
EEG = pop_loadbv('C:\Users\Zeno\Desktop\VRCodesMain', [fname '.vhdr'], [], [1:20,22:64]); %Loading .vhdr the file  
%Ignoring the ground channel 21
ALLEEG=[]
[ALLEEG EEG, CURRENTSET] = pop_newset(ALLEEG, EEG, 0,'setname',fname,'gui','off'); 
eeglab redraw
%Filtering
name = 'Walking_Anxiety';
...
%Removing bad components and their activities from dataset
EEG = pop_subcomp( EEG, EEG.bad, 0);
name = 'Walking_Anxiety_backproject';
[ALLEEG EEG CURRENTSET] = pop_newset(ALLEEG, EEG, 1,'setname',name,...
...
name = 'Final_Plot_Walking_Anxiety_Data';
print(1, '-dpng', name); 
close;
end