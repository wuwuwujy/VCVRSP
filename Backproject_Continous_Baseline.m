...
EEG = pop_loadset('filename','Walking_Baseline_postICA.set','filepath','C:\\Users\\Zeno\\Desktop\\VRCodesMain\\');
EEG = eeg_checkset( EEG );
...
load Baseline_ICA.mat

% open continuous data (epoch_set - channel location formation
EEG = eeg_checkset( EEG );
EEG = pop_loadset('filename','Walking_Baseline_eventchan.set','filepath','C:\\Users\\Zeno\\Desktop\\VRCodesMain\\');
EEG = eeg_checkset( EEG );
...
%Saving the Continous Backprojected Baseline Data
name = 'Walking_Baseline_backproject_continous'; % update based on current file
